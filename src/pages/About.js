...
export default function About() {
  ...
  const iAm =
    ...
    "다양한 프로젝트의 경험으로 웹퍼블리싱에 능숙한 경력 퍼블리셔로써, 동료들과의 협업을 통한 효율적인 업무 수행이 가능합니다. 웹 표준, 웹 접근성, 크로스 브라우징, 반응형 웹 등의 웹퍼블리싱 분야에서 전문성을 보유하고 있습니다. Vue, React 개발 환경에서 퍼블리싱을 할 수 있습니다.";
