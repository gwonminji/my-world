const data = {
  items: [
    ...
    },
    {
      ...
      detail:
        "비너스 브랜드의 자사 쇼핑몰 어플리케이션입니다. 퍼블리싱 파트를 전담하여 HTML, CSS, jQuery를 이용한 하이브리드앱 웹뷰 UI 개발을 담당했습니다. 오랫동안 운영되어 온 서비스를 리뉴얼하는 프로젝트로 디자인/개발 직군과 협업하여 UI/UX를 개선하는 작업을 진행했습니다.",
    },
    {
      id: 11,
      cate: "pc",
