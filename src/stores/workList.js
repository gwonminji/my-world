const data = {
  items: [
    ...
    },
    {
      ...
      summary: "메인 / 퍼블리싱 단독작업 / 반응형웹",
      url: "https://mkss.app/mkss",
      important: true,
      tag: ["#responsive", "#scss"],
      detail:
        "누구나 쇼핑몰을 개설할 수 있고, 쇼핑을 하면 후원이 되는 플랫폼입니다. 퍼블리싱 파트를 전담하여 PHP 환경에서 HTML, SCSS, jQuery를 이용한 UI 개발을 담당했습니다. 개발 직군과 협업하여 개인 취향을 고려한 쇼핑몰 테마(컬러) 선택 기능을 넣어 사용자가 선택한 테마(컬러)에 맞게 렌더링 되도록 구현했고, 반응형 UI를 적용하여 결과물의 완성도를 높였습니다.",
    },
    {
      id: 7,
      cate: "adaptive",
    ...
    },
    {
      ...
      detail:
        "비너스 브랜드의 자사 쇼핑몰 어플리케이션입니다. 오랫동안 운영되어 온 서비스를 리뉴얼하는 프로젝트로 디자인/개발 직군과 협업하여 UI/UX를 개선하는 작업을 진행했습니다. 퍼블리싱 파트를 전담하여 HTML, CSS, jQuery를 이용한 하이브리드앱 웹뷰 UI 개발을 담당했습니다.",
    },
    {
      id: 11,
      cate: "pc",
    ...
    },
    {
      ...
      detail:
        "삼성증권을 소개하기 위한 웹사이트입니다. 메인 페이지 진입 시 fullpage.js를 사용한 스크롤 인터랙션을 통해 사용자의 이목을 끌고 흥미를 유지하여 콘텐츠에 집중할 수 있도록 UI를 구현했습니다. 퍼블리싱 파트를 담당하여 HTML, CSS, jQuery를 이용한 반응형 UI를 적용했으며 웹 접근성 인증마크 획득으로 결과물의 완성도를 높였습니다.",
    },
    {
      id: 14,
      cate: "pc",
